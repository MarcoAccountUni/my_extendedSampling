...
from custom_esm.models.esmc import ESMC
...
from custom_esm.utils.constants.esm3 import data_root
...
#modified to use bfloat16 for inference to reduce memory usage and speed up inference
#modified to use cpu for loading the model to avoid memory issues on gpu
