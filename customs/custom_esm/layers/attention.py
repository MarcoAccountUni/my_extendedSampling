...
from custom_esm.layers.rotary import (
    RotaryEmbedding,
...
import math
from custom_esm.utils.custom import mean_dot_product_attention
...
class MultiHeadAttention(nn.Module):
    ...
    def attention(self, x, seq_id):
        ...
        if seq_id is not None:
            ...
            attn_BLL = mean_dot_product_attention(
                query_BHLD, key_BHLD, value_BHLD, mask_BHLL
            )
        else:
            # Shortcut, if we don't use attention biases then torch
